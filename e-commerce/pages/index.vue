<template>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            ...
            <div class="flex flex-wrap -m-4">
                <div class="xl:w-1/4 md:w-1/2 p-4" v-for="product in products">
                    <div class="bg-gray-100 p-6 rounded-lg">
                        <img class="thumb rounded w-full object-cover object-center mb-6" :src="product.image"
                            alt="content">
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            ...
            <button
                class="flex mx-auto mt-16 text-white bg-green-500 border-0 py-2 px-8 focus:outline-none hover:bg-green-600 rounded text-lg">Button</button>
        </div>
    </section>
